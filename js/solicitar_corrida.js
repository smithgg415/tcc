...
async function calcularRota() {
    ...
    try {
        ...
        const valorBase = 5;
        const valorPorKm = 0.6;
        const valorTotal = (valorBase + (valorPorKm * distanciaKm)).toFixed(2);
        ...
        document.getElementById('info-valor').textContent = `R$ ${valorTotal}`;
...
function mostrarPix() {
    ...
    var pixElement = document.getElementById('pix');
